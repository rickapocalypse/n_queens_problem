...
from models.my_hill import my_hill
from models.my_hill2 import my_hill2
...
class Controller:
    ...
    def change_selection(self, selection):
        ...
        elif selection == "My hill":
            self.__model = my_hill()
        elif selection == "My hill2":
            self.__model = my_hill2()   
